...
#now need to create the associate for the route table and subnet
resource "aws_route_table_associate" "subnet1"{
...
#can put all of the prior code into a setup module to call maybe
